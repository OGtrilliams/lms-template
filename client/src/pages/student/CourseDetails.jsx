  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        <div className="absolute top-0 left-0 w-full h-section-height z-1 bg-gradient-to-b from-cyan-200/70"></div>
        {/* left column */}
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p>
            Course by <span className="text-blue-600 underline">trilliams</span>
          </p>
                  ...
                  >
                    <ul className="list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300">
                      {chapter.chapterContent.map((lecture, i) => (
                        <li key={i} className="flex items-start gap2 py-1">
                          <img
          ...
          <div className="py-20 text-sm md:font-default">
        ...
        <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            ...
            <div className="flex items-center text-sm md:font-default gap-4 pt-2 md:pt-4 text-gray-500">
              <div className="flex items-center gap-1">
                <img src={assets.star} alt="stars" />
            ...
            <div className="pt-6">
              ...
              <ul className="ml-4 pt-2 text-sm md:font-default list-disc text-gray-500">
